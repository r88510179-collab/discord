...
The main risk is over-blocking valid parses. If ambiguity guards become too aggressive, narrow the guard conditions and preserve successful parsing for clearly structured inputs.

## Definition of done
- Additive implementation only
- Checks pass
- Docs updated only if behavior/config changed
- Follow-up recommendation included at PR end
