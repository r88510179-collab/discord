...
## Anti-pattern: full-time evidence for period markets (added 2026-07-08)

Grading a 1H/period market on the FT score. The verdict can coincide by luck, which makes this failure mode invisible in spot checks — audit the evidence, not just the verdict. Caught in WC-3: two 1H legs graded on FT data by the production grader. Rule now in methodology §Period-specific markets.
